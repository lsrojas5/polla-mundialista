  ...
  const generateImage = () => {
    ...
    const drawContent = (logoImage) => {
      ...
      if (logoImage) {
        ...
        ctx.drawImage(logoImage, logoX, 18, logoWidth, logoHeight);
      }
      ...
      ctx.fillText("POLLA DEL MUNDIAL AGSM", W/2, 125);
    ...
    logoImage.onload = () => drawContent(logoImage);
    logoImage.onerror = () => drawContent(null);
    logoImage.src = logoAgsm;

    if (logoImage.complete) {
      drawContent(logoImage);
    }
  };
